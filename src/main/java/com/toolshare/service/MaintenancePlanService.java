...
import com.toolshare.mapper.MaintenancePlanResponseMapper;
...
public class MaintenancePlanService {
    ...
    public PageResponse<MaintenancePlanResponse> getAllPlans(Boolean isActive, Boolean overdue,
        ...
        List<MaintenancePlanResponse> responseList = maintenancePlanResponseMapper.toResponseList(planPage.getContent(), today);
    ...
    public MaintenancePlanResponse getPlanById(Long id) {
        ...
        return maintenancePlanResponseMapper.toResponse(plan, LocalDate.now());
    }
    ...
    public MaintenancePlanResponse createPlan(CreateMaintenancePlanRequest request, Long currentUserId) {
        ...
        return maintenancePlanResponseMapper.toResponse(saved, LocalDate.now());
    }
    ...
    public Map<Long, MaintenancePlanResponse> getPlanMapByToolIds(List<Long> toolIds) {
        ...
        List<MaintenancePlanResponse> responses = maintenancePlanResponseMapper.toResponseList(plans, LocalDate.now());

        for (MaintenancePlanResponse response : responses) {
            result.put(response.getToolId(), response);
        }
        return result;
    }
